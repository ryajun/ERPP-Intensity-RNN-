...
class EventEmbedding(nn.Module):
    ...
    def __init__(self, type_size, embed_size, process_dim, dropout=0.1):
        """
        ...
        """
        super().__init__()
        self.type = TypeEmbedding(type_size=type_size, embed_size=embed_size,padding_idx=process_dim)
